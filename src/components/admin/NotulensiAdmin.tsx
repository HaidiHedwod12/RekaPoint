        ...
        {selected && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-slate-900 rounded-lg p-8 max-w-lg w-full overflow-y-auto max-h-[90vh]">
              ...
              <div className="mb-2 text-gray-300"><b>Judul:</b> {selected.judul?.nama || selected.judul_nama || '(Dihapus)'}</div>
              <div className="mb-2 text-gray-300"><b>Sub Judul:</b> {selected.subjudul?.nama || selected.subjudul_nama || '(Dihapus)'}</div>
