...
-- Allow admins to view all requests (simplified check)
...
-- Uncomment untuk insert test data jika diperlukan
/*
INSERT INTO reimbursement_requests (user_id, title, description, total_amount, status)
VALUES 
    ('your-user-id-here', 'Test Reimbursement', 'Test description', 100000, 'pending')
